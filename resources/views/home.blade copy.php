                ...
                <div class="card-body table-responsive table-sm">
                    <table id="listado" class="display table" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <button class="btn btn-sm btn-danger" onclick="openDatos('{{ $lead->id }}')"><i class="fas fa-pencil"></i></button>
                                </td>
                                ...
                                <td>{{ $lead->e }}</td>
                                @if ($user = Auth::user()->role == 'admin')
                                <td><i class="fas fa-close text-danger" role="button" onclick="fnEliminar({{ $lead->id }})"></i></td>
                                @endif
